...
const MiPerfil = () => {
  ...
  useEffect(() => {
    const loadProfile = async () => {
      try {
        ...
        const { data } = await api.get('/personal-area/me');
  ...
  const handleSubmitProfile = async (e) => {
    ...
    try {
      ...
      const { data } = await api.put('/personal-area/me', payload);
            ...
            <div className="card-body">
              ...
              <form onSubmit={handleSubmitProfile}>
                ...
                <div className="mb-3">
                  ...
                  <input type="email" className="form-control" name="correo" value={form.correo} onChange={handleChange} placeholder="tu@correo.com" />
